...
<html>
<head>
	<title>Jodhpuri Suit | Attire Men's Bespoke</title>
	...
	<div class="container">
		<div class="container-fluid">
			<div class="attire-heading1">
				<div class="attire-heading" id="attire-here"><h1>Jodhpuri Suit</h1></div>
			</div>
		</div>
	</div>
</section>
...
<section class="attire-images-container">
	<div class="container">
		<div class="row">
			...
			<div class="attire-row-images col-md-4 col-lg-4 col-sm-12">
				<img src="images/Jsuit5.jpg" width="100%;">
			</div>
		...
		<div class="row">
			<div class="attire-row-images col-md-4 col-lg-4 col-sm-12 ">
				<img src="images/Jsuit.jpg" width="100%;">
			</div>

			<div class="attire-row-images col-md-4 col-lg-4 col-sm-12">
				<img src="images/Jsuit2.JPG" width="100%;">
			</div>

			<div class="attire-row-images col-md-4 col-lg-4 col-sm-12">
				<img src="images/Jsuit3.JPG" width="100%;">
			</div>
		</div>
	</div>
</section>
